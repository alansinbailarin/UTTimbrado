...
const Inicio = () => {
    ...
    return (
      <div className="px-6 md:px-10">
        ...
        <div className="flex justify-between mt-4 space-y-3 mb-4 flex-col md:flex-row md:space-x-4 md:space-y-0 md:mb-4">
        ...
        <div className="md:flex md:justify-between bg-gray-200 rounded-xl border border-gray-200 py-6 md:p-6 md:text-left mb-4">
          <div>
              <h1 className="font-bold text-base text-gray-600 pl-4 md:pl-10">Estado civil</h1>
              <p className="text-md text-gray-400 pl-4 md:pl-0 md:text-center">10</p>
          </div>
          <div>
          ...
          <div>
              ...
              <p className="text-md text-gray-400 pl-4 md:pl-0 pr-4 md:pr-10 md:text-center">10</p>
          </div>
        </div>
        <div className="md:flex">
            <div className="md:w-1/2 bg-white border border-gray-200 p-4 rounded-xl mb-4 md:mr-2">
                <h1 className="text-blue-500 font-bold text-center mb-3">Tsu</h1>
                <Chart index={index} data={data}/>
            </div>
            <div className="md:w-1/2 bg-white border border-gray-200 p-4 rounded-xl mb-4 md:ml-2">
                <h1 className="text-blue-500 font-bold text-center mb-3">Ingenieria</h1>
                <Chart index={index} data={data}/>
            </div>
        </div>
        <div className="bg-white border border-gray-200 p-4 rounded-xl md:p-6 md:text-left mb-4">
          <h1 className="text-blue-500 font-bold text-center mb-3">Ingresos</h1>
          <Chart index={index} data={data}/>
        </div>
      </div>
    )
